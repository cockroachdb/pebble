...
func TestFormatMajorVersionStableValues(t *testing.T) {
	...
	require.Equal(t, FormatSyntheticSuffixes, FormatMajorVersion(18))
...
func TestRatchetFormat(t *testing.T) {
	...
	require.NoError(t, d.RatchetFormatMajorVersion(FormatSyntheticSuffixes))
	require.Equal(t, FormatSyntheticSuffixes, d.FormatMajorVersion())
...
func TestFormatMajorVersions_TableFormat(t *testing.T) {
	...
	m := map[FormatMajorVersion][2]sstable.TableFormat{
		...
		FormatSyntheticSuffixes:          {sstable.TableFormatPebblev1, sstable.TableFormatPebblev4},
	}
