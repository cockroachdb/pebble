...
func iterOptions(kf KeyFormat, o iterOpts) *pebble.IterOptions {
	...
	if o.filterMin != nil {
		...
		if o.filterMin != nil && o.filterMax != nil &&
			kf.Comparer.ComparePointSuffixes(o.filterMin, o.filterMax) >= 0 {
		...
		opts.SkipPoint = func(k []byte) (skip bool) {
			...
			if o.filterMin != nil && kf.Comparer.ComparePointSuffixes(k[n:], o.filterMin) <= 0 {
				return true
			}
