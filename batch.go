...
// have been filled into Key and valueDest. Not calling Finish or not
...
// object.
//
// Code duplication between Set and SetDeferred lets us preserve the fast path
// where the entire byte slices are available (in the Set case)
...
// returned object.
//
// Code duplication with Merge is so that the Merge case (where byte slices are
// provided) can preserve the fast path.
...
// returned object.
//
// Code duplication with Delete is so that the Delete case (where byte slices
