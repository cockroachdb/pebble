...
func (b *Batch) newInternalIter(o *IterOptions) (it internalIterator, refresh func()) {
	if b.index == nil {
		return newErrorIter(ErrNotIndexed), func() {}
	}
	iter := &batchIter{
		cmp:      b.cmp,
		batch:    b,
		iter:     b.index.NewIter(o.GetLowerBound(), o.GetUpperBound()),
		snapshot: b.nextSeqNum(),
	}
	return iter, func() { iter.snapshot = b.nextSeqNum() }
}

func (b *Batch) newRangeDelIter(_ *IterOptions) (it keyspan.FragmentIterator, refresh func()) {
	if b.index == nil {
...
func (b *Batch) initRangeDelIter(iter *keyspan.Iter) {
	if b.rangeDelIndex == nil {
		iter.Init(b.cmp, nil)
		return
	}
...
func (b *Batch) newRangeKeyIter(_ *IterOptions) (it keyspan.FragmentIterator, refresh func()) {
	if b.index == nil {
		return newErrorKeyspanIter(ErrNotIndexed), func() {}
	}
	...
	// unchanged.
	refresh = func() { b.initRangeKeyIter(iter) }
	refresh()
	return iter, refresh
}

func (b *Batch) initRangeKeyIter(iter *keyspan.Iter) {
	if b.rangeKeyIndex == nil {
		iter.Init(b.cmp, nil)
		return
	}
...
func batchSort(
	...
	b := i.(*Batch)
	if b.Indexed() {
		pointIter, _ := b.newInternalIter(nil)
		rangeDelIter, _ := b.newRangeDelIter(nil)
		rangeKeyIter, _ := b.newRangeKeyIter(nil)
