...
type Batch struct {
	...
	// RANGEKEYSET, RANGEKEYUNSET or RANGEKEYDEL key is added.
	...
	// requested. The cache is invalidated whenever a new range key (either Set
	// or Unset) is added to the batch.
