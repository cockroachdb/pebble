...
// memtabl, both of which are outside the purview of the commit
...
// waiting for the wAL sync after ratcheting the visibile sequence number
// allows another goroutine to read committed data before the WAL has
// synced. This is similar behavior to RocksDB's manual WAL flush
// functionality. Application code needs to protect against this if necessary.
//
