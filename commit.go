...
// held while this is called. DB.mu must not be held. Note that DirectWrite is
// a special case function which is currently only used when ingesting sstables
// as a memtable. Reason carefully about the correctness argument when calling
// this function from any context.
