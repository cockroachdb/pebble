...
type commitEnv struct {
	...
	// asynchronously and done will be called on wait group upon completion. If
	// wg != nil and err != nil, a failure to persist the WAL will populate
	// *err. Returns the memtable the batch should be applied to. Serial
