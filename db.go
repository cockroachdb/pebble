...
type KeyStatistics struct {
	...
	// snapshotActivePinnedKeys represents the number of keys that are pinned due to open snapshots.
	snapshotActivePinnedKeys int
	// the total number of bytes of all active snapshot pinned keys.
	snapshotActivePinnedKeysBytes uint64
