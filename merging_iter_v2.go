...
//
// If it isn't able to pack all the key information in a
// spanKeysChangeDetector, returns ok=false and a spanKeysChangeDetector for
// which MayHaveChanged always returns true.
