...
func TestBatchEmpty(t *testing.T) {
	...
	ops := []func(*Batch){
		func(b *Batch) { b.Set(nil, nil, nil) },
		func(b *Batch) { b.Merge(nil, nil, nil) },
		func(b *Batch) { b.Delete(nil, nil) },
		func(b *Batch) { b.DeleteRange(nil, nil, nil) },
		func(b *Batch) { b.LogData(nil, nil) },
		func(b *Batch) { b.Experimental().RangeKeySet(nil, nil, nil, nil, nil) },
		func(b *Batch) { b.Experimental().RangeKeyUnset(nil, nil, nil, nil) },
		func(b *Batch) { b.Experimental().RangeKeyDelete(nil, nil, nil) },
	}
