...
func TestBatchReset(t *testing.T) {
	...
	require.Equal(t, uint32(1), b.countRangeDels)
	require.Equal(t, uint32(1), b.countRangeKeys)
	...
	require.Equal(t, uint32(0), b.countRangeDels)
	require.Equal(t, uint32(0), b.countRangeKeys)
