...
func flushExternalTable(untypedDB interface{}, path string, originalMeta *fileMetadata) error {
	...
	if originalMeta.HasPointKeys {
		m.MaybeExtendPointKeyBounds(d.cmp, originalMeta.SmallestPointKey, originalMeta.LargestPointKey)
	}
	if originalMeta.HasRangeKeys {
		m.MaybeExtendRangeKeyBounds(d.cmp, originalMeta.SmallestRangeKey, originalMeta.LargestRangeKey)
	}
