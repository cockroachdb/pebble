...
func ingestLoad1(
	opts *Options, fmv FormatMajorVersion, path string, sharedReadable objstorage.Readable, cacheID uint64, fileNum base.DiskFileNum,
) (*fileMetadata, error) {
...
func ingestLoad(
	...
	for i := range paths {
		m, err := ingestLoad1(opts, fmv, paths[i], nil /* sharedReadable */, cacheID, pending[i])
		if err != nil {
