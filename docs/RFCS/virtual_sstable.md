...
upper/lower bounds on the smallest and largest sequence numbers in L0. If such
support isn't possible, we'd have to perform scans of the sstable being split
to determine the precise sequence numbers.
