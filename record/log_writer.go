...
// The head index is stored in the most-significant 32 bits, and the tail index
// is stored in the least-significant 32 bits. The mask is used to isolate the
// relevant bits for each index.
