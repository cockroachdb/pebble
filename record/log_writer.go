...
const noOpByte = byte(255)

// noOpSequence is a 4-byte sequence of noOpByte (255) used to mark cases
// where there are between 11 and 18 bytes remaining in a block. This helps
// record.Reader distinguish between the recyclable and sync formats.
var noOpSequence = []byte{noOpByte, noOpByte, noOpByte, noOpByte}
