...
type GeneralizedValueSeparation struct {
	...
	//
	// INVARIANT: sum(blobTiers.totalPreservedValueSize) == sum(currPreservedReferenceValueSizes)
...
var _ ValueSeparation = &GeneralizedValueSeparation{}
...
func (vs *GeneralizedValueSeparation) SetNextOutputConfig(config ValueSeparationOutputConfig) {
...
func (vs *GeneralizedValueSeparation) Kind() sstable.ValueSeparationKind {
	if vs.mode == preserveAllHotBlobReferences {
...
func (vs *GeneralizedValueSeparation) MinimumSize() int {
...
func (vs *GeneralizedValueSeparation) EstimatedReferenceSize() uint64 {
...
// separation.
func (vs *GeneralizedValueSeparation) separateValue(
	...
	if vs.mode == preserveAllHotBlobReferences {
		panic("separateValue called in preserveAllHotBlobReferences mode")
	}
...
func (vs *GeneralizedValueSeparation) preserveBlobReference(
...
func (vs *GeneralizedValueSeparation) closeWriters(
...
func (vs *GeneralizedValueSeparation) maybeCheckInvariants() {
...
func (vs *GeneralizedValueSeparation) FinishOutput() (ValueSeparationMetadata, error) {
