...
// pointIter. It requires the pointIter's mergingIter and levelIter be
// configured with pointers to its combinedIterState. When the levelIter
// observes a file containing a range key, the lazyCombinedIter constructs the
// combined range+point key iterator stack and switches to it.
