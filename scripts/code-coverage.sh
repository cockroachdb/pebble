...
go run github.com/cockroachdb/code-cov-utils/convert@convert -out artifacts/profile-tests.lcov \
  -trim-prefix github.com/cockroachdb/pebble/ \
  artifacts/profile-tests.gocov

go run github.com/cockroachdb/code-cov-utils/convert@convert -out artifacts/profile-meta.lcov \
  -trim-prefix github.com/cockroachdb/pebble/ \
  artifacts/profile-meta.gocov

go run github.com/cockroachdb/code-cov-utils/convert@convert -out artifacts/profile-tests-and-meta.lcov \
  -trim-prefix github.com/cockroachdb/pebble/ \
