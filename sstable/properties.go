...
type CommonProperties struct {
	...
	CompressionName string `prop:"rocksdb.compression" options:"encodeempty"`
	// The compression options used to compress blocks.
	CompressionOptions string `prop:"rocksdb.compression_options" options:"encodeempty"`
}
...
type Properties struct {
	...
	ComparerName string `prop:"rocksdb.comparator" options:"encodeempty"`
	...
	MergerName string `prop:"rocksdb.merge.operator" options:"encodeempty"`
	...
	// table.
	PropertyCollectorNames string `prop:"rocksdb.property.collectors" options:"encodeempty"`
