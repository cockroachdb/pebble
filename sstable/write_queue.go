...
type writeTask struct {
	...
	// estimatedUncompressedSize is used to decrement Writer.coordination.sizeEstimate.inflightSize.
...
func (w *writeQueue) performWrite(task *writeTask) error {
	...
	w.writer.coordination.sizeEstimate.dataBlockWritten(
		w.writer.meta.Size, task.estimatedUncompressedSize, int(bh.Length),
	)
