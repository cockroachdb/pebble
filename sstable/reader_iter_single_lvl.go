...
func (i *singleLevelIterator) seekPrefixGE(
	...
	err := i.err
	i.err = nil // clear cached iteration error
	if i.shouldUseBloomFilter(filterBlockSizeLimit) {
...
func (i *singleLevelIterator) shouldUseBloomFilter(filterBlockSizeLimit FilterBlockSizeLimit) bool {
	return i.reader.tableFilter != nil && i.reader.filterBH.Length <= uint64(filterBlockSizeLimit)
}
