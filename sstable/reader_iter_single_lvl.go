...
func (i *singleLevelIterator) skipForward() (*InternalKey, base.LazyValue) {
	for {
		...
		//
		// TODO(radu): find a way to elide this check if we are just iterating
		// through the table. We should only need to check it if the bound was
		// exhausted when Next was called.
