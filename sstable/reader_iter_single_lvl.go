...
func (i *singleLevelIterator) seekPrefixGE(
	...
	err := i.err
	i.err = nil // clear cached iteration error
	if shouldUseBloomFilter(i.reader, filterBlockSizeLimit) {
...
// shouldUseBloomFilter returns whether we should use a bloom filter, based on
// its length and the size limit.
func shouldUseBloomFilter(reader *Reader, filterBlockSizeLimit FilterBlockSizeLimit) bool {
