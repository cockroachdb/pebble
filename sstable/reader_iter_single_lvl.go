...
func (i *singleLevelIterator) skipForward() (*InternalKey, base.LazyValue) {
	for {
		...
		//
		//   Index block 1 - contains keys a@1, c@1
		//   Index block 2 - contains keys e@1, g@1
		//   Index block 3 - contains keys i@2, k@2
		//
		...
		useSeek := i.vState != nil &&
			(!i.index.valid() ||
				(i.data.isDataInvalidated() && base.InternalCompare(i.cmp, i.index.ikey, i.vState.lower) < 0))
