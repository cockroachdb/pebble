...
// SetBoundsWithVirtualPrefix indicates whether this iterator requires keys
...
// as-is, i.e. with the virtual prefix still on them.
//
...
// virtual prefix in order to combine them with the vState bounds. Thus, if this
// iterator knows bounds will be passed to vState, it can signal that it they
// should be passed without being rewritten to skip converting back and forth.
func (i singleLevelIterator) SetBoundsWithVirtualPrefix() bool {
	return i.vState != nil
}
