...
func (i *singleLevelIterator) loadBlock(dir int8) loadBlockResult {
	...
	i.err = i.data.initHandle(i.cmp, i.reader.Split, block, i.reader.Properties.GlobalSeqNum, i.hideObsoletePoints, i.reader.syntheticPrefix, i.reader.SyntheticSuffix)
	if i.err != nil {
