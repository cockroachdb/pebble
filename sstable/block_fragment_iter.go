...
func (i *fragmentBlockIter) decodeSpanKeys(kv *base.InternalKV, internalValue []byte) error {
	...
	case base.InternalKeyKindRangeDelete:
		i.span = rangedel.Decode(kv.InternalKey, internalValue, i.span.Keys)
	case base.InternalKeyKindRangeKeySet, base.InternalKeyKindRangeKeyUnset, base.InternalKeyKindRangeKeyDelete:
		i.span, err = rangekey.Decode(kv.InternalKey, internalValue, i.span.Keys)
	default:
		i.span = keyspan.Span{}
...
func (i *fragmentBlockIter) gatherForward(kv *base.InternalKV) (*keyspan.Span, error) {
	...
	internalValue := kv.LazyValue.InPlaceValue()
	...
	kv = i.blockIter.Next()
	for kv != nil && i.blockIter.cmp(kv.InternalKey.UserKey, i.span.Start) == 0 {
