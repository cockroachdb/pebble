...
func BenchmarkIteratorScanNextPrefix(b *testing.B) {
	...
	// versions=1/method=seek-ge-10         	21847268	        54.85 ns/op
	// versions=1/method=next-prefix-10     	35048689	        34.33 ns/op
	// versions=2/method=seek-ge-10         	13214499	        91.18 ns/op
	// versions=2/method=next-prefix-10     	33468252	        35.75 ns/op
	// versions=10/method=seek-ge-10        	 1292239	       926.6 ns/op
	// versions=10/method=next-prefix-10    	15245499	        78.31 ns/op
	// versions=100/method=seek-ge-10       	 1163350	      1030 ns/op
	// versions=100/method=next-prefix-10   	 4282164	       278.6 ns/op
	//
