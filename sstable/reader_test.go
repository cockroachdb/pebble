...
func TestReaderFeatureSet(t *testing.T) {
	defer leaktest.AfterTest(t)()
	opts := WriterOptions{
	...
	runTestReader(t, opts, "testdata/reader_featureset", nil /* Reader */, false)
}
	...
	datadriven.Walk(t, dir, func(t *testing.T, path string) {
		...
		datadriven.RunTest(t, path, func(t *testing.T, d *datadriven.TestData) string {
			...
			case "build":
				...
				var cacheSize int
				var printLayout, printFeatures bool
				...
				d.MaybeScanArgs(t, "print-features", &printFeatures)
				...
				if printFeatures {
					...
					buf.WriteString(r.Features.String())
				}
				return buf.String()
