...
type ColumnWriter interface {
	...
	// column. The caller may pass Size to calculate the exact size required. If
	// [rows] is ≤ the highest row index at which a value has been set, Finish
	// will only serialize the first [rows] values.
	//
