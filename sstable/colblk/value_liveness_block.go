...
// an array of bytes encoding the liveness of values within blob files referenced
// by an sstable. The indexes into this array are the blob.ReferenceIDs contained
// within the sstable.
