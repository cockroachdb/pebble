...
func (rw *DataBlockRewriter) RewriteSuffixes(
	...
	rw.writer.Reset()
	if err = rw.iter.Init(&rw.reader, rw.keySeeker, rw.compare, rw.split, nil, block.IterTransforms{}); err != nil {
...
func (c *MultiDataBlockIter) InitHandle(
	...
	return c.DataBlockIter.Init(&c.r, c.KeySchema.NewKeySeeker(), cmp, split, c.GetLazyValuer, t)
}
...
func (i *DataBlockIter) Init(
	...
	*i = DataBlockIter{
		...
		kvRow:         math.MinInt,
		kv:            base.InternalKV{},
		keyIter:       PrefixBytesIter{buf: keyIterBuf},
	}
	...
	i.noTransforms = i.transforms.SyntheticSeqNum == 0 &&
...
// account the synthetic prefix and suffix.
