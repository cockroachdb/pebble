...
func (i *twoLevelIterator) loadIndex(dir int8) loadBlockResult {
	...
	if i.err = i.index.initHandle(i.cmp, indexBlock, i.reader.Properties.GlobalSeqNum, false, i.reader.syntheticPrefix, nil); i.err == nil {
		return loadBlockOK
	}
	return loadBlockFailed
}
...
func (i *twoLevelIterator) init(
	...
	err = i.topLevelIndex.initHandle(i.cmp, topLevelIndexH, r.Properties.GlobalSeqNum, false, r.syntheticPrefix, nil)
	if err != nil {
