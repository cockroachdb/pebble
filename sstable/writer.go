...
func shouldFlushWithHints(
	...
	// 2048B class, which increases fragmentation.
	...
	sizeClassAwareThreshold := (targetBlockSize*base.SizeClassAwareBlockSizeThreshold + 99) / 100
	if blockSizeWithMetadata <= sizeClassAwareThreshold || newEstimatedSize <= targetBlockSize {
		return false
	}
	...
	if blockSizeWithMetadata < targetBlockSize {
