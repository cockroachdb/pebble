...
func (m *WriterMetadata) SetSmallestPointKey(cmp Compare, k base.InternalKey) {
	m.SmallestPoint = k
...
func (m *WriterMetadata) SetSmallestRangeDelKey(cmp Compare, k base.InternalKey) {
...
// also update the overall lower bound in the metadata.
func (m *WriterMetadata) SetSmallestRangeKey(cmp Compare, k base.InternalKey) {
...
func (m *WriterMetadata) SetLargestPointKey(cmp Compare, k base.InternalKey) {
	m.LargestPoint = k
	if !(m.HasPointKeys || m.HasRangeDelKeys || !m.HasRangeKeys) ||
...
func (m *WriterMetadata) SetLargestRangeDelKey(cmp Compare, k base.InternalKey) {
	m.LargestRangeDel = k
	if !(m.HasPointKeys || m.HasRangeDelKeys || m.HasRangeKeys) ||
		base.InternalCompare(cmp, k, m.Largest) > 0 {
		m.Largest = k
...
func (m *WriterMetadata) SetLargestRangeKey(cmp Compare, k base.InternalKey) {
	m.LargestRangeKey = k
	if !(m.HasPointKeys || m.HasRangeDelKeys || m.HasRangeKeys) ||
		base.InternalCompare(cmp, k, m.Largest) > 0 {
		m.Largest = k
