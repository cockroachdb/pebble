...
type Decompressor interface {
	...
	DecompressedLen(b []byte) (decompressedLen int, prefixLength int, err error)
}
...
func (noopDecompressor) DecompressedLen(
	b []byte,
...
func (snappyDecompressor) DecompressedLen(
	b []byte,
) (decompressedLen int, prefixLength int, err error) {
...
func (zstdDecompressor) DecompressedLen(
	b []byte,
) (decompressedLen int, prefixLength int, err error) {
