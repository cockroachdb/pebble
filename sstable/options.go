...
// SetDisableValueBlocks sets the value of WriterOptions.DisableValueBlocks.
func (o WriterOptions) SetDisableValueBlocks(disableValueBlocks bool) WriterOptions {
	o.DisableValueBlocks = disableValueBlocks
	return o
}
