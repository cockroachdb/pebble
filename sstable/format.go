...
// limited the number of foreign sst levels to two, and is fragile. For more
// robust correctness, non-obsolete SINGLEDELs in foreign sstables should be
// exposed as DELs.
//
...
// ScanInternal) does not support SINGLEDEL. So the fact that SINGLDELs are
// exposed as SINGLEDELs is harmless.
//
