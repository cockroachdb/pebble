...
func readFooter(f vfs.File) (footer, error) {
...

	{
		...
		if n == 0 || footer.metaindexBH.Offset > end || footer.metaindexBH.Offset+footer.metaindexBH.Length > end {
		...
		if n == 0 || footer.indexBH.Offset > end || footer.indexBH.Offset+footer.indexBH.Length > end {
