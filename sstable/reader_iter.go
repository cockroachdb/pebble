...
type (
	...
	singleLevelIteratorColumnBlocks = singleLevelIterator[colblk.IndexIter, *colblk.IndexIter, colblk.DataBlockIterConfig, *colblk.DataBlockIterConfig]
	twoLevelIteratorColumnBlocks    = twoLevelIterator[colblk.IndexIter, *colblk.IndexIter, colblk.DataBlockIterConfig, *colblk.DataBlockIterConfig]
)
...
func init() {
	...
	singleLevelIterColumnBlockPool = sync.Pool{
		New: func() interface{} {
			...
			// Note: this is a no-op if invariants are disabled or race is enabled.
			invariants.SetFinalizer(i, checkSingleLevelIterator[colblk.IndexIter, *colblk.IndexIter, colblk.DataBlockIterConfig, *colblk.DataBlockIterConfig])
			return i
		},
	}
	twoLevelIterColumnBlockPool = sync.Pool{
		New: func() interface{} {
			...
			// Note: this is a no-op if invariants are disabled or race is enabled.
			invariants.SetFinalizer(i, checkTwoLevelIterator[colblk.IndexIter, *colblk.IndexIter, colblk.DataBlockIterConfig, *colblk.DataBlockIterConfig])
			return i
		},
	}
}
