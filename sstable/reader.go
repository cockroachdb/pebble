...
func (rs *readaheadState) maybeReadahead(offset, blockLength uint64) uint64 {
	...
	if rs.numReads >= minFileReadsForReadahead {
		...
		// beneficial.
		if rs.prevSize == 0 || (currentReadEnd >= rs.limit && offset <= rs.limit + maxReadaheadSize) {
		...
		// moment.
		//
		// (rs.limit - maxReadaheadSize)        (rs.limit + maxReadaheadSize)
		//                    |+++++++++++++|===============|
		//                             (rs.limit)
		//
		//                        |-------|
