...
// ReadBlobRefIndexBlock implements valblk.ExternalBlockReader, allowing a
// base.LazyValue to read a blob ref index block.
func (r *Reader) ReadBlobRefIndexBlock(ctx context.Context) (block.BufferHandle, error) {
	return r.readBlobRefIndexBlock(ctx, block.NoReadEnv, noReadHandle)
}
