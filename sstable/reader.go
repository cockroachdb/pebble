...
const (
	...
	// keys with a suffix matching the first half that property's value should
	// have that suffix replaced with the bytes in the second half, which must
	// be of the same length, e.g. to have all keys ending in "aaa" instead end
	// in "bbb", it would be set to "aaabbb".
