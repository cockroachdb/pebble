...
// Package batchrepr provides interfaces for reading the binary batch
// representation. This batch representation is used in-memory while
...
const (
	...
	// uin32 count is, encoded as a little-endian uint32.
	countOffset = 8
)
