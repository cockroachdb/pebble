...
func (i *invalidatingIter) update(key *InternalKey, value base.LazyValue) (*InternalKey, base.LazyValue) {
	i.zeroLast()
...
func (i *invalidatingIter) SeekGE(key []byte, flags base.SeekGEFlags) (*InternalKey, base.LazyValue) {
...
func (i *invalidatingIter) SeekLT(key []byte, flags base.SeekLTFlags) (*InternalKey, base.LazyValue) {
...
func (i *iterSeekOptWrapper) SeekGE(key []byte, flags base.SeekGEFlags) (*InternalKey, base.LazyValue) {
