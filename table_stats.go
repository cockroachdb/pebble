...
func compressionTypesForLevel(v *version, level int) (unknown, snappy, zstd uint64) {
	if v.Levels[level].Empty() {
		return
	}
	...
	return compression.unknown, compression.snappy, compression.zstd
}
