...
func pointDeletionsBytesEstimate(
	...
	if props.RawPointTombstoneKeySize > 0 {
		...
		keysLogicalSize = 2 * numPointDels * props.RawKeySize
	}
	...
	//
	// The calculation is refactored to avoid rounding/truncation.
...
func estimateValuePhysicalSize(fileSize uint64, props *sstable.Properties) (avgValSize uint64) {
	...
	return props.RawValueSize * fileSizePerEntry / uncompressedSum
}
