...
func generateSublevelInfo(cmp base.Compare, levelFiles manifest.LevelSlice) []sublevelInfo {
	...
	// Sort sublevels in descending order.
	sort.Sort(sort.Reverse(sort.IntSlice(sublevels)))
...
type pickedCompaction struct {
	...
	// L0SublevelInfo is used for compactions out of L0. It is nil for all other
	// compactions. It is ordered descending by sublevel (eg, more recent data
	// first.)
