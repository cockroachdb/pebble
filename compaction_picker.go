...
func expandInputs(cmp Compare, inputs manifest.LevelSlice) manifest.LevelSlice {
...
func (p *compactionPickerByScore) pickFile(level, outputLevel int) manifest.LevelSlice {
