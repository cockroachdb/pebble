...
func (pc *pickedCompaction) initMultiInputLevelCompaction(opts *Options, vers *version,
	levelMaxBytes [7]int64,
	diskAvailBytes uint64) bool {
...
func (pc *pickedCompaction) setupMultiInputLevelCompaction(opts *Options, diskAvailBytes uint64) bool {
