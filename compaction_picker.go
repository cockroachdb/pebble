...
type compactionPickerByScore struct {
	...
	// Per-level size adjustment based on in-progress compactions. Updated on
	// every call to pickFile.
	sizeAdjust [numLevels]int64

	// Per-level compaction scores. Updated on every call to pickFile.
