...
func (l *levelIter) makeSyntheticBound(userKey []byte) *base.InternalKV {
...
func (l *levelIter) SeekPrefixGE(prefix, key []byte, flags base.SeekGEFlags) *base.InternalKV {
	...
	if l.rangeDelIterPtr != nil && *l.rangeDelIterPtr != nil {
		if l.tableOpts.UpperBound != nil {
			l.largestBoundary = l.makeSyntheticBound(l.tableOpts.UpperBound)
			l.exhaustedDir = +1
		...
		l.largestBoundary = l.makeSyntheticBound(l.iterFile.LargestPointKey.UserKey)
		return l.verify(l.largestBoundary)
	}
	...
	for ; kv == nil; kv = l.iter.Last() {
		...
		if l.rangeDelIterPtr != nil {
			...
			if l.tableOpts.LowerBound != nil {
				l.exhaustedDir = -1
				if *l.rangeDelIterPtr != nil {
					l.smallestBoundary = l.makeSyntheticBound(l.tableOpts.LowerBound)
			...
			if *l.rangeDelIterPtr != nil {
				l.smallestBoundary = l.makeSyntheticBound(l.iterFile.SmallestPointKey.UserKey)
				return l.smallestBoundary
			}
		}
