...
func (l *levelIter) SetBounds(lower, upper []byte) {
	// TODO: this requires l.opts != nil. The other iterator implementations do not have that
	// restriction. Why do we share the l.opts across all levelIters in a mergingIter?
	// Each levelIter in a mergingIter will do the same assignment to the shared opts.
