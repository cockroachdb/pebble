...
func (d *dbT) runProperties(cmd *cobra.Command, args []string) {
	...
	err := func() error {
		...
		fmt.Fprintln(tw, "creation time\t\t\t\t\t\t\t\t")
		fmt.Fprintf(tw, "  earliest\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
			propArgs(all, func(p *props) interface{} { return formatTime(p.EarliestCreationTime) })...)
		fmt.Fprintf(tw, "  latest\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
			propArgs(all, func(p *props) interface{} { return formatTime(p.LatestCreationTime) })...)
		...
		fmt.Fprintf(tw, "  data\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.DataSize })...)
		fmt.Fprintf(tw, "    blocks\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.NumDataBlocks })...)
		fmt.Fprintf(tw, "  index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.IndexSize })...)
		fmt.Fprintf(tw, "    top-level\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.TopLevelIndexSize })...)
		fmt.Fprintf(tw, "  filter\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.FilterSize })...)
		fmt.Fprintf(tw, "  raw-key\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.RawKeySize })...)
		fmt.Fprintf(tw, "  raw-value\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.RawValueSize })...)

		fmt.Fprintln(tw, "records\t\t\t\t\t\t\t\t")
		fmt.Fprintf(tw, "  set\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.NumEntries - p.NumDeletions - p.NumMergeOperands })...)
		fmt.Fprintf(tw, "  delete\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.NumDeletions })...)
		fmt.Fprintf(tw, "  range-delete\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.NumRangeDeletions })...)
		fmt.Fprintf(tw, "  merge\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
			propArgs(all, func(p *props) interface{} { return p.NumMergeOperands })...)
...
func (p *props) update(o props) {
	p.Count += o.Count
	if o.EarliestCreationTime != 0 && (o.EarliestCreationTime < p.EarliestCreationTime || p.EarliestCreationTime == 0) {
