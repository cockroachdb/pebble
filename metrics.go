...
// a total:
//
//   __level_____count____size___score______in__ingest(sz/cnt)____move(sz/cnt)___write(sz/cnt)____read___w-amp
...
func (m *Metrics) String() string {
	...
	fmt.Fprintf(&buf, "__level_____count____size___score______in__ingest(sz/cnt)"+
		"____move(sz/cnt)___write(sz/cnt)____read___w-amp\n")
	m.formatWAL(&buf)
