...
type Options struct {
	...
	private struct {
		...
		// forceReadSampling is used for test purposes to force a read sample on every
		// read. This is used to avoid non-deterministic test behavior due to the random
		// variable.
