...
const (
	...
	// separately if it can reduce write amplification. Pebble may choose to
	// separate values under this policy even if they would not otherwise be
	// separated according to the global Options' ValueSeparationPolicy.
