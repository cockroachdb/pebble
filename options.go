...
type Options struct {
	...
	MaxConcurrentCompactions func() uint64
...
func (o *Options) EnsureDefaults() *Options {
	...
	if o.MaxConcurrentCompactions == nil {
		o.MaxConcurrentCompactions = func() uint64 { return 1 }
	}
		...
		case section == "Options":
			...
			case "max_concurrent_compactions":
				...
				if concurrentCompactions < 0 {
					panic("max_concurrent_compactions cannot be < 0")
				}
				o.MaxConcurrentCompactions = func() uint64 { return uint64(concurrentCompactions) }
