...
type scanInternalOptions struct {
	...
	// pointKeyVisitor is a function that should be called with all point keys
	// encountered by this iterator.
	pointKeyVisitor func(key *InternalKey, value LazyValue) error
}
