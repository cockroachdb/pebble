...
const (
	...
	UseDefaultValueStorage ValueStoragePolicyAdjustment = iota
	...
	// separation, Pebble may choose to separate values under the
	// OverrideValueStorage policy even if they do not meet the minimum size
	// threshold of the global Options' ValueSeparationPolicy.
