...
func (o *Options) String() string {
	...
	fmt.Fprintf(&buf, "  range_deletions_flush_delay=%s\n", o.Experimental.RangeDeletionFlushDelay)
...
func (o *Options) Parse(s string, hooks *ParseHooks) error {
	return parseOptions(s, func(section, key, value string) error {
		...
		case section == "Options":
			...
			case "range_deletions_flush_delay":
				o.Experimental.RangeDeletionFlushDelay, err = time.ParseDuration(value)
			case "table_format":
				switch value {
				case "leveldb":
