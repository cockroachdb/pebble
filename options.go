...
const (
	...
	defaultVirtualTableGarbageRatio = 0.3
)
...
type Options struct {
	...
	Experimental struct {
		...
		// VirtualTableRewriteGarbageRatio configures the minimum
		...
		VirtualTableRewriteGarbageRatio func() float64
	}
...
func (o *Options) EnsureDefaults() {
	...
	if o.Experimental.VirtualTableRewriteGarbageRatio == nil {
		o.Experimental.VirtualTableRewriteGarbageRatio = func() float64 { return defaultVirtualTableGarbageRatio }
	}
