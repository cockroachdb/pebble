...
var (
	...
	DBTableFilterPolicyProgressive = func() DBTableFilterPolicy {
		...
		const limit512KB = 512*1024 - block.AllocationOverheadAllowance
		...
		// and 16bpk for L0-L3. For L6 we use smaller 5bpk filters to keep the total
		// filter size under control.
		//
		...
		return DBTableFilterPolicy{
			...
			6: bloom.AdaptivePolicy(5, limit512KB),
		}
	}()
)
