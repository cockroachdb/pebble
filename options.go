...
type Options struct {
	...
	Experimental struct {
		...
		// MinTombstoneDenseRatio is the minimum ratio of tombstone-dense
		// data blocks that must be present in a single table for it to be
		// eligible for a tombstone density compaction. The default value is 0.05.
		// Tables with a higher ratio of tombstone-dense blocks are still
		// prioritized for compaction.
		MinTombstoneDenseRatio float64
...
func (o *Options) EnsureDefaults() *Options {
	...
	if o.Experimental.MinTombstoneDenseRatio == 0 {
		o.Experimental.MinTombstoneDenseRatio = 0.05
	}
...
func (o *Options) String() string {
	...
	fmt.Fprintf(&buf, "  min_tombstone_dense_ratio=%f\n", o.Experimental.MinTombstoneDenseRatio)
	...
	return parseOptions(s, func(section, key, value string) error {
		...
		case section == "Options":
			...
			case "deletion_size_ratio_threshold":
				...
				err = parseErr
			case "min_tombstone_dense_ratio":
				o.Experimental.MinTombstoneDenseRatio, err = strconv.ParseFloat(value, 64)
