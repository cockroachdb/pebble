...
func (d *DB) runCompaction(
	...
	sizeSplitter := compact.FileSizeSplitter(&iter.frontiers, c.maxOutputFileSize, c.grandparents.Iter())
	...
	outputSplitters := []compact.OutputSplitter{
		...
		compact.UserKeyChangeSplitter(c.cmp, sizeSplitter, unsafePrevUserKey),
