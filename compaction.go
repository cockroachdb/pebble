...
type compaction struct {
	...
	// given start key by calling rangeDelInterleaving's Span method. When range
	// deletions are present, rangeDelInterleaving will be the outermost
	// iterator used by the compaction input iterator.
