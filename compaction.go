...
func (c *compaction) newInputIter(
	...
	addItersForLevel := func(level *compactionLevel, l manifest.Level) error {
		...
		// deletions into memory upfront. (See #2015, which reverted this.) This
		// requires there to be no user keys that are split between sstables
		// within a level. We will have this guarantee in Cockroach 23.1.
