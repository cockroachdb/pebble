...
func TestSharedMultipleLocators(t *testing.T) {
	...
	// Check that an invalid locator errors out.
	_, err = p2.AttachSharedObjects("invalid", []objstorage.SharedObjectToAttach{{
		FileNum:  file2,
		FileType: base.FileTypeTable,
		Backing:  b1,
	}})
	...
	_, err = p2.AttachSharedObjects("foo", []objstorage.SharedObjectToAttach{{
		FileNum:  file2,
		FileType: base.FileTypeTable,
		Backing:  b1,
	}})
	...
	b2, err := h2.Get()
	require.NoError(t, err)
	_, err = p1.AttachSharedObjects("bar", []objstorage.SharedObjectToAttach{{
		FileNum:  file2,
		FileType: base.FileTypeTable,
		Backing:  b2,
	}})
