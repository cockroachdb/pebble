...
type provider struct {
	...
	mu struct {
		...
		// lastLocalSyncCounter is the value of localObjectsChangeCounter value at the
		// time the last completed sync was launched.
		lastLocalSyncCounter uint64
		// inProgressLocalSyncCh is set if a vfsSync is currently in progress. The
		// channel is closed after lastLocalSyncCounter is updated.
		inProgressLocalSyncCh chan struct{}
