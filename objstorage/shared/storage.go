...
//
// It is stored in the shared object catalog; any sensitive information within
// the string will be visible to anyone who has access to the store files.
//
// The locator can also appear in error messages.
type Locator string
