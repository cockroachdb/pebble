...
type CreateOptions struct {
	...
	// UseColdTier causes the object to be created on the cold tier, if the
	// provider has a local cold tier configured. PreferSharedStorage takes
	// precedence over UseColdTier.
	UseColdTier bool
