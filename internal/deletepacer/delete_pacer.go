...
// DeleteFn is called to perform the actual deletion of an obsolete file.
// It should not panic.
...
func Open(
	...
	dp.mu.numDeletedCond.L = &dp.mu.Mutex
	dp.waitGroup.Add(1)
	go func() {
...
func (dp *DeletePacer) mainLoop() {
	...
	for {
		...
		default:
			...
			dp.mu.numDeleted++
			dp.mu.numDeletedCond.Broadcast()
		}
	}
}
...
func (dp *DeletePacer) WaitForTesting() {
	...
	n := dp.mu.numEnqueued
	for dp.mu.numDeleted < n {
		dp.mu.numDeletedCond.Wait()
	}
}
