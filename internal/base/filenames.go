...
const (
	...
	// New FormatMajorVersions should be added here.
	//
	// Ensure you update FormatNewest to point to your new
	// FormatMajorVersion.
	//
	// Also, ensure you export the constant you define here in the main
	// pebble package.

	// TODO(jackson): Test the CURRENT-XXXXXX -> CURRENT-YYYYYY
	// migration when it's possible; especially the deletion of the old
	// CURRENT-XXXXXX file.
