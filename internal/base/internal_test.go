...
func TestInternalKeySeparator(t *testing.T) {
	testCases := []struct {
		...
		{"foo.SET.100", "hello.SET.200", "g.BLOBINDEX.72057594037927935"},
		{"ABC1AAAAA.SET.100", "ABC2ABB.SET.200", "ABC2.BLOBINDEX.72057594037927935"},
		{"AAA1AAA.SET.100", "AAA2AA.SET.200", "AAA2.BLOBINDEX.72057594037927935"},
		{"AAA1AAA.SET.100", "AAA4.SET.200", "AAA2.BLOBINDEX.72057594037927935"},
		{"AAA1AAA.SET.100", "AAA2.SET.200", "AAA1B.BLOBINDEX.72057594037927935"},
		{"AAA1AAA.SET.100", "AAA2A.SET.200", "AAA2.BLOBINDEX.72057594037927935"},
