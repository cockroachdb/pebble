...
type InternalIteratorStats struct {
	...
	// CacheMissFetchDuration accumulates the duration spent fetching a block
	...
	CacheMissFetchDuration time.Duration
...
func (s *InternalIteratorStats) Merge(from InternalIteratorStats) {
	...
	s.CacheMissFetchDuration += from.CacheMissFetchDuration
