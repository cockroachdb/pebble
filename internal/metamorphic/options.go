...
func randomOptions(rng *rand.Rand) *testOptions {
	...
	if rng.Intn(4) == 0 {
		// Enabled block writes in parallel for 25% of the random options.
		// Setting MaxWriterConcurrency to any value greater than or equal to
		// 1 has the same effect currently.
