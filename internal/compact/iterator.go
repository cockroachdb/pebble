...
// It extends MetaDecoder, so any iterator implementing MetaIterator also
// implements MetaDecoder.
...
func NewIter(
	...
	if metaIter, ok := i.iter.(MetaIterator); ok {
		i.metaIter = metaIter
	}
