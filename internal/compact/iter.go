...
func (i *compactionIter) Next() (*base.InternalKey, []byte) {
	...
	for i.iterKey != nil {
		...
		if i.iterKey.Kind() == base.InternalKeyKindRangeDelete || rangekey.IsRangeKey(i.iterKey.Kind()) {
...
func (i *compactionIter) nextInStripeHelper() stripeChangeType {
	...
	for {
		...
		if prevSeqNum := base.SeqNumFromTrailer(i.keyTrailer); (prevSeqNum == 0 || prevSeqNum <= key.SeqNum()) &&
			i.key.Kind() != base.InternalKeyKindRangeDelete && key.Kind() != base.InternalKeyKindRangeDelete {
			prevKey := i.key
		...
		case base.InternalKeyKindRangeKeySet, base.InternalKeyKindRangeKeyUnset,
			base.InternalKeyKindRangeKeyDelete, base.InternalKeyKindRangeDelete:
			...
			// this.
			panic("unreachable")
		case base.InternalKeyKindDelete, base.InternalKeyKindSet, base.InternalKeyKindMerge,
			base.InternalKeyKindSingleDelete, base.InternalKeyKindSetWithDelete, base.InternalKeyKindDeleteSized:
			// Fall through
		default:
			kind := i.iterKey.Kind()
			i.iterKey = nil
...
func (i *compactionIter) setNext() {
	...
	if i.iterKey.Kind() == base.InternalKeyKindSetWithDelete {
		i.skip = true
		return
	}
...
func (i *compactionIter) mergeNext(valueMerger base.ValueMerger) {
	// Save the current key.
	i.saveKey()
	i.valid = true
...
func (i *compactionIter) deleteSizedNext() (*base.InternalKey, []byte) {
	...
	for i.nextInStripe() == sameStripe {
		...
		case base.InternalKeyKindDelete, base.InternalKeyKindDeleteSized, base.InternalKeyKindSingleDelete:
			...
			i.valueBuf = append(i.valueBuf[:0], i.iterValue...)
			i.value = i.valueBuf
			if i.iterKey.Kind() != base.InternalKeyKindDeleteSized {
...
func (i *compactionIter) Key() base.InternalKey {
	return i.key
}
