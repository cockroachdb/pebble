...
type Fragmenter struct {
	...
	//
	// WARNING: The Keys slice of the Span is owned by the Fragmenter and may
	// not be retained.
	Emit func(Span)
...
// the user keys depend on whether the block is prefix compressed. Pebble does
// not prefix compress range deletion and range key blocks, so these keys are
// stable.
