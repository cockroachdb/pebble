...
func (i *InterleavingIter) InitSeekGE(
	...
	// We leave i.pos as posUninitialized so that a subsequent Prev will seek
...
func (i *InterleavingIter) InitSeekLT(key []byte, pointKV *base.InternalKV) *base.InternalKV {
	...
	// i.pos as posUninitialized so that a subsequent Next will seek the
