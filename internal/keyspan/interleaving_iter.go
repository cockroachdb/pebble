...
//
//	i.lower ≤ key
func (i *InterleavingIter) SeekGE(key []byte, flags base.SeekGEFlags) (*base.InternalKey, base.LazyValue) {
	i.clearMask()
	i.disablePrefixMode()
...
func (i *InterleavingIter) SeekLT(key []byte, flags base.SeekLTFlags) (*base.InternalKey, base.LazyValue) {
	i.clearMask()
	i.disablePrefixMode()
...
func (i *InterleavingIter) yieldSyntheticSpanMarker(lowerBound []byte) (*base.InternalKey, base.LazyValue) {
...
func (i *InterleavingIter) verify(k *base.InternalKey, v base.LazyValue) (*base.InternalKey, base.LazyValue) {
