...
func (i *InterleavingIter) yieldSyntheticSpanMarker(lowerBound []byte) *base.InternalKV {
	i.spanMarker.InternalKey.UserKey = i.startKey()
	i.spanMarker.InternalKey.Trailer = base.MakeTrailer(base.InternalKeySeqNumMax, i.span.Keys[0].Kind())
	...
	if lowerBound != nil && i.cmp(lowerBound, i.startKey()) > 0 {
		...
		i.spanMarker.InternalKey.UserKey = i.keyBuf
