...
func TestLevelIterEquivalence(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		iter1.Init(base.DefaultComparer.Compare, KeyStabilityNextOp, visibleTransform(base.InternalKeySeqNumMax), fileIters...)
		iter2.Init(base.DefaultComparer.Compare, KeyStabilityNextOp, visibleTransform(base.InternalKeySeqNumMax), levelIters...)
