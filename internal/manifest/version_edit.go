...
func (b *BulkVersionEdit) Accumulate(ve *VersionEdit) {
	...
	for _, nf := range ve.NewFiles {
		// A file should never be both deleted and added to the same level in
		// one VersionEdit, but we are being defensive here and ignoring the
		// deletion.
		// TODO(sbhola): return an error?
