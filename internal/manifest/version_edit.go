...
type VersionEdit struct {
	...
	// CreatedBackingTables can be used to preserve the BackingState associated
	...
	// present in NewFiles.
	CreatedBackingTables []*BackingState
	// RemovedBackingTables is used to remove the BackingState associated with a
	...
	// future version edit.
	//
	// RemovedBackingTables is populated by BulkVersionEdit.ApplyAndCompleteVersionEdit
	...
	// and RemovedBackingTables. A file must be present in RemovedBackingTables in
...
func (b *BulkVersionEdit) Accumulate(ve *VersionEdit) error {
	...
	b.AddedBackingState = append(b.AddedBackingState, ve.CreatedBackingTables...)
	...
	b.RemovedBackingState = append(b.RemovedBackingState, ve.RemovedBackingTables...)
...
func AccumulateIncompleteAndApplySingleVE(
	...
	backingStateMap map[base.FileNum]*BackingState,
