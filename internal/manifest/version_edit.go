...
//   also true for all of the calls to Accumulate for a single bulk version
//   edit.
...
//   edit.
// - A file must be added to a level before(in a prior version edit) it is
//   removed from the level. Note that a given file can be added and deleted
//   from two different levels in the same version edit.
...
//   BulkVersionEdit.{Added, Deleted} for the given level.
