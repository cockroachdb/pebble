...
// incoming Version.
//
// Note that zombie table computation is only accurate if exactly one version
// edit was accumulated in the BulkVersionEdit.Accumulate step.
func (b *BulkVersionEdit) Apply(
	...
	for level := range v.Levels {
		...
		// NB: addedFilesMap may be empty, and it is internally consistent with
		// deletedMap.
