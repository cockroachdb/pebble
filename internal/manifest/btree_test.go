...
func (o orderStatistic) Zero() interface{} {
	return 0
}

func (o orderStatistic) Value(meta *FileMetadata) (interface{}, bool) {
	return 1, true
}

func (o orderStatistic) Merge(values []interface{}) interface{} {
	sum := 0
