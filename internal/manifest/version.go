...
type FileMetadata struct {
	...
	// virtual sstable creation, as asynchronously computing these isn't
	// currently supported.
	//
	// TODO(bananabrick): If Pebble is restarted, then we'll lose the stats
	// for virtual sstables. In this case, we'd have to compute that stats
	// for the physical sstables, and then asyncrhonously set the stats for
	// virtual sstables, or we'd have to write the stats to the version edit.
	// We should probably just support asynchronous computation.
	Stats TableStats
