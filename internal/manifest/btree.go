...
func cmpIter(a, b iterator) int {
	...
	//
	// If the iterators' paths ever diverge and point to different pages, the
	// iterators are not equal and we use the page positions to evaluate the
	// comparison.
	//
	...
	// Iniitalize with the iterator's current node and position. These are
	...
	// sentinel case when both iterators' first frame points to the last page
