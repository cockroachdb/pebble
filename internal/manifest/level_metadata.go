...
// SmallestBound returns the smallest bound of this key-type of the provided
// file. Returns a false second return value if the file does not contain any
// keys of the provided key-type.
func (kt KeyType) SmallestBound(m *FileMetadata) (*InternalKey, bool) {
	switch kt {
