...
// BlobFileAnnotatorFuncs groups the functions that define a blob file
// annotator.
...
// NewBlobAnnotationIdx generates a unique BlobFileAnnotationIdx that can be
// used with blob file annotators. It should be called during global
// initialization.
