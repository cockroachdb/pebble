...
// operations. Applying a batch is an O(n logn) operation where N is the number
// of records in the batch. The commitPipeline serializes batch preparation,
// and allows batch application to proceed concurrently.
//
