...
func rangeDelConstructSpan(
	...
	if ik.Kind() != base.InternalKeyKindRangeDelete {
		return keyspan.Span{}, base.CorruptionErrorf("pebble: rangeDelConstructSpan called on %s key kind", ik.Kind())
	}
	keysDst = append(keysDst, keyspan.Key{Trailer: ik.Trailer})
	return keyspan.Span{
		Start: ik.UserKey,
		End:   v,
		Keys:  keysDst,
