...
func newMemTable(o *Options, reserved *int64) *memTable {
	o = o.EnsureDefaults()
	m := &memTable{
	...
	if reserved != nil {
		size := o.MemTableSize
		atomic.AddInt64(reserved, int64(size))
		reservation := o.Cache.Reserve(size)
		m.memReservation = func() {
			atomic.AddInt64(reserved, -int64(size))
			reservation()
		}
	}
