...
// TestOpenWALReplayReadOnlySeqNums tests opening in read-only mode a database
// with multiple unflushed log files to be replayed that proceed in sequence
// number the last sequence number written to the MANIFEST.
