...
// key, however we don't guarantee that we generate and return a SetWithDel if a
// set shadows a del. Point keys deleted by rangedels are also considered
// shadowed and not exposed.
//
