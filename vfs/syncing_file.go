...
func (f *syncingFile) Close() error {
	...
	//
	// NB: If the file is capable of non-durability-guarantee SyncTos,
	// syncOffset is guaranteed to be less than atomic.offset. This ensures we
	// fall into the below conditional and perform a full sync to durably
	// persist the file.
