...
func (windowsDir) Attributes() FileAttributes {
...
func (f windowsFile) Preallocate(offset, length int64) error {
...
func (f windowsFile) SyncData() error {
	return f.Sync()
}

func (f windowsFile) SyncTo(off uint64) error {
	// No-op.
	return nil
}
