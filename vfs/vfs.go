...
type File interface {
	...
	// Attributes describes the file and its capabilities. See FileAttributes
	// for a description of the available attributes and their meaning.
	...
	// file's Attributes() method should return CanSyncTo=false to indicate that
...
// FileAttributes describes the attributes and capabilities of a file.
