...
func (i *Iterator) nextPrefixKey() {
	...
	// after a limited forward-iteration method, it behaves as a simple Next and
	// nextPrefixKey is not invoked
...
// prefix than the current key. When switching directions or called after
// reaching a limit, NextPrefix moves the iterator to the next user key,
