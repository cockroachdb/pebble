...
type Iterator struct {
	...
	// if it's already positioned in the correct place. If iterator's view of
	// its indexed batch was just refreshed, some optimizations cannot be
	// applied on the first seek after the refresh:
