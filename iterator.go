...
func (i *Iterator) SetOptions(o *IterOptions) {
	...
	if i.opts.OnlyReadGuaranteedDurable != o.OnlyReadGuaranteedDurable {
		closePoint, closeRange = true, true
	}
	...
	if i.opts.TableFilter != nil || o.TableFilter != nil {
		closePoint, closeRange = true, true
	}
	...
	if len(i.opts.PointKeyFilters) > 0 || len(o.PointKeyFilters) > 0 {
		closePoint = true
	}
	if len(i.opts.RangeKeyFilters) > 0 || len(o.RangeKeyFilters) > 0 {
		closeRange = true
	}
