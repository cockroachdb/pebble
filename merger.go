...
func finishValueMerger(valueMerger ValueMerger, includesBase bool) (value []byte, needDelete bool, closer io.Closer, err error) {
	...
	needDelete = needDelete && includesBase
	return
}
