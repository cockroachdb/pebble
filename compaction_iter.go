...
// call frontiers.update, passing itself in order to reposition the frontier
// within the heap.
...
// advance notifies all member frontiers with user keys ≤ k and restores the
// heap for updated frontiers.
