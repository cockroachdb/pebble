...
func (i *compactionIter) nextInStripe() stripeChangeType {
	...
	case InternalKeyKindRangeDelete:
		...
		// number and are encountered before any keys with the same user key as
		// the start bound. The above user key check will always return
		// newStripe before falling into this codepath.
		panic("unreachable")
