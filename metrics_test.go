...
func TestMetricsFormat(t *testing.T) {
	...
	m.Snapshots.Count = 27
	m.Snapshots.EarliestSeqNum = 128
	m.Snapshots.PinnedKeys = 29
	m.Snapshots.PinnedKeysSize = 30
...
__level_____count____size___score______in__ingest(sz_cnt)____move(sz_cnt)___write(sz_cnt)____read___r-amp___w-amp
  ...
  flush         8
  snaps        27     128    30 B      29          (size = earliest-seq, score = pinned-size, in = pinned-count)
...
__level_____count____size___score______in__ingest(sz_cnt)____move(sz_cnt)___write(sz_cnt)____read___r-amp___w-amp
  ...
  flush         0
  snaps         0       0     0 B       0          (size = earliest-seq, score = pinned-size, in = pinned-count)
