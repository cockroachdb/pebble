...
__level_____count____size___score______in__ingest(sz_cnt)____move(sz_cnt)___write(sz_cnt)____read___r-amp___w-amp
  ...
  flush         8                            35 B      34      36  (ingest = ingested-as-flushable, move = tables-ingested)
...
__level_____count____size___score______in__ingest(sz_cnt)____move(sz_cnt)___write(sz_cnt)____read___r-amp___w-amp
  ...
  flush         0                             0 B       0       0  (ingest = ingested-as-flushable, move = tables-ingested)
