...
func (wm *failoverManager) Init(o Options) error {
	...
	fmOpts := failoverMonitorOptions{
		dirs:                               dirs,
		primaryDirProbeInterval:            o.PrimaryDirProbeInterval,
		healthyProbeLatencyThreshold:       o.HealthyProbeLatencyThreshold,
		healthyInterval:                    o.HealthyInterval,
		unhealthySamplingInterval:          o.UnhealthySamplingInterval,
		unhealthyOperationLatencyThreshold: o.UnhealthyOperationLatencyThreshold,
		elevatedWriteStallThresholdLag:     o.ElevatedWriteStallThresholdLag,
		stopper:                            stopper,
		timeSource:                         o.timeSource,
		monitorIterationForTesting:         o.monitorIterationForTesting,
		proberIterationForTesting:          o.proberIterationForTesting,
		monitorStateForTesting:             o.monitorStateForTesting,
	}
