...
func TestVirtualReadsWiring(t *testing.T) {
	...
	v2 := &manifest.FileMetadata{
		...
		SmallestSeqNum:   parentFile.SmallestSeqNum,
		LargestSeqNum:    parentFile.LargestSeqNum,
		Smallest:         base.MakeInternalKey([]byte{'d'}, parentFile.Smallest.SeqNum()+100, InternalKeyKindRangeDelete),
		Largest:          base.MakeInternalKey([]byte{'z'}, parentFile.Largest.SeqNum(), InternalKeyKindSet),
		SmallestPointKey: base.MakeInternalKey([]byte{'d'}, parentFile.Smallest.SeqNum()+100, InternalKeyKindRangeDelete),
		LargestPointKey:  base.MakeInternalKey([]byte{'z'}, parentFile.Largest.SeqNum(), InternalKeyKindSet),
		SmallestRangeKey: base.MakeInternalKey([]byte{'f'}, parentFile.Smallest.SeqNum()+100, InternalKeyKindRangeKeySet),
