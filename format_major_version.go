...
func (v FormatMajorVersion) String() string {
	...
	// on-disk version marker file. Specifically, this value must always
	// parse as a 10-digit uint64.
...
// panic if a migration returns a non-nil error but fails to finalize
// the new format major version.
