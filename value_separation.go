...
// best-effort basis; see comments in RawColumnWriter's evaluatePoint for the
...
func (vs *writeNewBlobFiles) Add(
	...
	isSeparableMVCCKey := isLikelyMVCCGarbage && len(v) != 0 && kv.K.Kind() == base.InternalKeyKindSet
