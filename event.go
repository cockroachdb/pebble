...
type DiskSlowInfo struct {
	...
	Path string
	// Type of file that was being written to (eg. "sstable", "WAL").
	Type string
...
func (i DiskSlowInfo) SafeFormat(w redact.SafePrinter, _ rune) {
	w.Printf("write to %s file %s has been ongoing for %s",
		redact.Safe(i.Type), i.Path, redact.Safe(i.Duration))
}
